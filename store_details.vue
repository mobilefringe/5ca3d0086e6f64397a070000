    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), #753241 url(' + pageBanner.image_url + ') center center' }">
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8917)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8913)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8914)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8915)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8916)) {
