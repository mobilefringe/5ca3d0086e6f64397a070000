                ...
                <div class="main_container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/xhyhjk/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                        <label for="fieldgijiid" class="visuallyhidden">First Name</label>
                                        <input v-model="form_data.first_name" required class="margin_20 form-control" id="fieldgijiid" name="cm-f-gijiid" type="text" placeholder="First Name">
                                    </div>
                                    <div class="col-sm-6" >
                                        <label for="fieldgijiih" class="visuallyhidden">Last Name</label>
                                        <input v-model="form_data.last_name" required class="margin_20 form-control" id="fieldgijiih" name="cm-f-gijiih" type="text" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="newsletter_email" class="visuallyhidden">Email</label>
                                        <input v-model="form_data.email" required class="margin_20 form-control" name="cm-xhyhjk-xhyhjk" type="email" placeholder="Email" id="newsletter_email">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
            ...
            created() {
                this.loadData().then(response => {
                    ...
                    if(temp_repo != null && temp_repo != undefined) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5dddd8806e6f6416db490000/image/png/1554995151000/plazapaseo_banner.png"
                        }
                    }
