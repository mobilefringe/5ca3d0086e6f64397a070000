require.config({
    paths: {
        ...
        'vue-social-sharing': 'https://cdn.jsdelivr.net/npm/vue-social-sharing@2.4.2/dist/vue-social-sharing.min',
    ...
    const vm = new Vue({
        ...
        methods: {
            loadData: async function() {
                try{
                    await this.$store.dispatch('initializeApi', { site: "paseoreal", version: "v4" });
